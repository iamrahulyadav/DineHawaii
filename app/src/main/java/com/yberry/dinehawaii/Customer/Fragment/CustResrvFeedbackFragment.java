...
import com.yberry.dinehawaii.Customer.Adapter.CustResrvFeedbackAdapter;
 ...
 */
public class CustResrvFeedbackFragment extends Fragment {
    private static final String TAG = "CustResrvFeedbackFragment";
    public static
    CustResrvFeedbackAdapter adapter;
    ...
    public CustResrvFeedbackFragment() {
    ...
    private void initView(View rootView) {
        ...
        adapter = new CustResrvFeedbackAdapter(getActivity(), list);
