...
public class SentCoupons extends Fragment {
    ...
    private void dataAvailableCoupon() {
        ...
        if (Util.isNetworkAvailable(getActivity())) {
            ...
            jsonObject.addProperty("method", AppConstants.CUSTOMER_USER.SENT_EGIFT);
            ...
            Log.e(TAG, "purchase coupon json " + jsonObject.toString());
    ...
    private void getDataFromServerAvailableCoupon(JsonObject jsonObject) {
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                Log.e(TAG, "purchase coupon Response :- " + response.body().toString());
