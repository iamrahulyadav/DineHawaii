...
public class CompletedTakeoutFragment extends Fragment {
    private static final String TAG = "CloseToday orderTakeout";
    ...
    private void getOrders() {
        if (Util.isNetworkAvailable(getActivity())) {
            ...
            jsonObject.addProperty("method", AppConstants.BUSSINES_USER_BUSINESSAPI.COMPLETE_TAKEOUT_ORDERS);
