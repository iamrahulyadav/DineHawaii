...
import com.yberry.dinehawaii.Bussiness.Adapter.DeliveryOrdersAdapter;
...
public class CompletedDeliveryOrdersFragment extends Fragment{
    ...
    private static final String TAG = "CompletedDeliveryOrdersFragment";
    ...
    private void initComponent() {
        ...
        adapter = new DeliveryOrdersAdapter(context, list);
    ...
    private void getOrders() {
        if (Util.isNetworkAvailable(getActivity())) {
            ...
            new CompletedDeliveryOrdersFragment.GetDataTask().execute();
        } else {
    ...
    class GetDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("method", AppConstants.BUSSINES_USER_BUSINESSAPI.COMPLETE_HOME_DELIVERY_ORDERS);
            ...
            Log.e(TAG, "Request GET CLOSEDELIVERY ORDER >> " + jsonObject.toString());
