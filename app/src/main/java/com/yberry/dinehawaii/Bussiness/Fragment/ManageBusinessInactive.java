...
public class ManageBusinessInactive extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_manage_business_inactive, container, false);
        context = getActivity();
        setAdapter();
        return view;
    }
    ...
    private void getData() {
        if (Util.isNetworkAvailable(getActivity())) {
            ...
            jsonObject.addProperty("method", AppConstants.BUSSINES_USER_BUSINESSAPI.GET_MY_DISABLED_BUSINESS);
