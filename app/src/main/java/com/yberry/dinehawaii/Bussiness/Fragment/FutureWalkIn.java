...
import com.yberry.dinehawaii.Bussiness.Adapter.WalkInFutureAdapter;
...
public class FutureWalkIn extends Fragment implements View.OnClickListener  {
    public WalkInFutureAdapter adapter;
    ...
    private String tableId = "0",  selectedDate;
...
/*
        if(getArguments() != null) {
            ...
            try {
                reservList = bdl.getParcelableArrayList("LIStRESERVFuTURE");
                Log.d("ListReservFuture", reservList + "");
...
*/
        ...
        adapter = new WalkInFutureAdapter(context,reservList,FutureWalkIn.this);
...
*/
    ...
    private void setAdapterForDate(View rootView)
    {
        ...
        //dateAdapter.setDropDownViewResource(R.layout.row_spn_dropdown);
    ...
    private void getFreeTableData() {
        ...
        jsonObject.addProperty("date", "07/10/2017");   //selectedDate
        Log.d("TABLEJSON12", "Current walkin Json Request :- " + jsonObject.toString());
    ...
    private void getCustomerDetail() {
        if (Util.isNetworkAvailable(getActivity())) {
            ...
            Log.e("JSONOBEJECTFUTURE:", jsonObject.toString());
