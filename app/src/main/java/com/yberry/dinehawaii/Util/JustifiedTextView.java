...
/**
 * Created by JAI on 3/25/2017.
 */

public class JustifiedTextView extends WebView{
    private String core      = "<html><body style='text-align:justify;color:rgba(%s);font-size:%dpx;margin: 0px 0px 0px 0px;font-family:myfont; src:('file:///android_asset/font/Raleway-Regular.ttf');'>%s</body></html>";
    //private String textColor = "0,0,0,255";
    private String textColor = "128,128,128";
    private String text      = "";
