...
class CountryCodeAdapter extends RecyclerView.Adapter<CountryCodeAdapter.CountryCodeViewHolder> {
    ...
    class CountryCodeViewHolder extends RecyclerView.ViewHolder {
        ...
        CustomTextView textView_name, textView_code;
        ...
        public CountryCodeViewHolder(View itemView) {
            ...
            textView_name = (CustomTextView) relativeLayout_main.findViewById(R.id.textView_countryName);
            textView_code = (CustomTextView) relativeLayout_main.findViewById(R.id.textView_code);
