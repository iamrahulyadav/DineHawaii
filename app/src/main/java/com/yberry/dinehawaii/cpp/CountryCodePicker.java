package com.yberry.dinehawaii.cpp;
...
public class CountryCodePicker extends RelativeLayout {
    ...
    CustomTextView textView_selectedCountry;
    ...
    private void init(AttributeSet attrs) {
        ...
        textView_selectedCountry = (CustomTextView) holderView.findViewById(R.id.textView_selectedCountry);
    ...
    private void setTextView_selectedCountry(CustomTextView textView_selectedCountry) {
