package com.yberry.dinehawaii.instagram_integration;
...
public class InstagramApp
{
    ...
    public static final String TAG_PROFILE_URL = "profile_picture";
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    userInfo.put(TAG_PROFILE_URL, data_obj.getString(TAG_PROFILE_URL));
                    Log.e("hashmap", userInfo.toString());
                }
                catch (Exception ex)
                {
                    what = WHAT_ERROR;
